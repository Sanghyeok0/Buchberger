...
-/
def IsGrobnerBasis (I : Ideal (MvPolynomial σ R)) (G : Finset (MvPolynomial σ R)) : Prop :=
  G.toSet ⊆ I ∧ Ideal.span (G.image fun g => leadingTerm m g) = initialIdeal m I
...
noncomputable def remainder'
  ...
  (f : MvPolynomial σ R) : MvPolynomial σ R := sorry
-- match m.div hb f with
-- | ⟨g, r, hfg, hprop⟩ => r
